...
export default class Auth extends Client {
  constructor(options = {}) {
    ...
    this.getEntityHistory.entry = {"args":["entityType","entityId"],"category":"Audit","method":"get","name":"getEntityHistory","output":true,"query":["prefix","continuationToken","limit"],"route":"/audit/<entityType>/<entityId>","scopes":"auth:audit-history:<entityType>","stability":"experimental","type":"function"}; // eslint-disable-line
